...
def main():
    ...
    print("="*70)
    print("Step-9 Phase-1: Hyperparameter Tuning - ResNet-50")
    print("="*70)
    ...
    for i, config in enumerate(all_configs, 1):
        ...
        results_df.to_csv(results_dir / 'tuning_resnet50_fold0.csv', index=False)
    ...
    print("\n" + "="*70)
    print("TUNING COMPLETE - ResNet-50")
    print("="*70)
    ...
    with open(configs_dir / 'best_resnet50.yaml', 'w') as f:
        yaml.dump(config_dict, f, default_flow_style=False)
    
    print(f"\n✓ Saved best config to: configs/best_resnet50.yaml")
